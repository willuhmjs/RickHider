...
<form>
    <input type="radio" checked bind:group={selectedPreview} name="platform" value="TwitterFacebook" id="TwitterFacebook">
    <label id="left" for="TwitterFacebook"><i class="fa-brands fa-twitter"></i> Twitter and <i class="fa-brands fa-facebook"></i> Facebook</label>
  
    <input type="radio" name="platform" bind:group={selectedPreview} value="Discord" id="Discord">
    <label id="right" for="Discord"><i class="fa-brands fa-discord"></i> Discord</label>
</form>
